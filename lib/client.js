...
.bmon-gh-body{display:flex;gap:2px;width:100%;align-items:stretch;}
...
.bmon-gh-cell{flex:1 1 0;min-width:6px;min-height:8px;border-radius:2px;background:var(--bmon-h0);}
