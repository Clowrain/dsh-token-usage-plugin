...
.bmon-gh-scroll{overflow-x:auto;overflow-y:hidden;padding:12px 0 2px;position:relative;flex:1 1 0;min-height:0;}
...
.bmon-gh-cell{flex:1 1 0;width:100%;min-height:9px;border-radius:3px;background:var(--bmon-h0);}
...
.bmon-legend-item{display:inline-flex;gap:4px;align-items:center;}
...
@container (min-width:1000px){
  ...
  .bmon-charts-grid{display:grid;grid-template-columns:45fr 55fr;align-items:stretch;}
...
@container (max-width:599px){
  ...
  .bmon-col-cache{display:none;}
      ...
      function UsageBars({ daily, range }) {
        ...
        children.push(React.createElement('div', { key: 'head', className: 'bmon-u-card-head' },
          ...
          React.createElement('span', { className: 'bmon-legend-box', style: { marginLeft: 'auto' } },
            React.createElement('span', { className: 'bmon-legend-item' }, React.createElement('i', { style: { background: 'var(--bmon-c1)' } }), '新输入'),
            React.createElement('span', { className: 'bmon-legend-item' }, React.createElement('i', { style: { background: 'var(--bmon-c2)' } }), '输出'),
            React.createElement('span', { className: 'bmon-legend-item' }, React.createElement('i', { style: { background: 'var(--bmon-c3)' } }), '缓存命中'),
      ...
      function UsageModal({ onClose }) {
        ...
        const cloudIcon = React.createElement(Icon, { paths: '<path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/><path d="M12 11v6"/><path d="m9 14 3-3 3 3"/>', size: 16 })
        ...
        if (!snapshot) {
          ...
          // 图表区：趋势在前（第一眼看到费用+tokens+趋势），日历在后
          bodyChildren.push(React.createElement(Section, {
