...
.bmon-gh-scroll{overflow-x:auto;overflow-y:hidden;padding:20px 0 4px;position:relative;}
.bmon-gh-months{position:absolute;top:0;left:18px;right:0;height:18px;pointer-events:none;}
.bmon-gh-month{position:absolute;top:4px;font-size:10px;color:var(--dsw-alias-label-secondary);white-space:nowrap;}
.bmon-gh-body{display:flex;gap:2px;box-sizing:border-box;width:100%;align-items:stretch;padding-right:4px;}
