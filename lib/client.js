...
.bmon-msg-line{font-size:11px;color:var(--dsw-alias-label-secondary);text-align:right;padding:0;margin:-4px 0;min-height:0;}
/* —— Body 与折叠模块 —— */
...
.bmon-u-tile-value{font-size:22px;font-weight:600;line-height:1.2;color:var(--dsw-alias-label-primary);}
.bmon-u-tile-value small{font-size:11px;font-weight:400;color:var(--dsw-alias-label-secondary);margin-left:4px;}
.bmon-u-tile-sub{font-size:10px;color:var(--dsw-alias-label-secondary);opacity:.8;display:flex;flex-direction:column;gap:2px;}
.bmon-hit-badge{display:inline-flex;align-items:center;gap:6px;padding:3px 10px;border-radius:999px;font-size:14px;font-weight:600;line-height:1.3;}
.bmon-hit-ok{background:color-mix(in srgb,var(--dsw-alias-state-success-primary) 18%,transparent);color:var(--dsw-alias-state-success-primary);}
.bmon-hit-warn{background:color-mix(in srgb,var(--dsw-alias-state-warn-primary) 20%,transparent);color:var(--dsw-alias-state-warn-primary);}
.bmon-hit-err{background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 18%,transparent);color:var(--dsw-alias-state-error-primary);}
...
.bmon-gh-cell{flex:none;width:100%;aspect-ratio:1.15/1;border-radius:3px;background:var(--bmon-h0);}
...
@container (max-width:599px){
  ...
  .bmon-col-cache{display:none;}
      ...
      function UsageModal({ onClose }) {
        ...
        const bodyChildren = []
        if (syncMsg) bodyChildren.push(React.createElement('div', { key: 'msg', className: 'bmon-msg-line' }, syncMsg))
        if (!snapshot) {
