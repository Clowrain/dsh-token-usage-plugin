...
.bmon-u-tiles{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;}
      ...
      function UsageTiles({ stats, range }) {
        ...
        const tiles = [
          ...
          React.createElement('div', { key: 't4', className: 'bmon-u-tile' },
            ...
            React.createElement('div', { className: 'bmon-u-tile-value' }, hit === null ? '—' : Math.round(hit) + '%'),
            React.createElement('div', { className: 'bmon-u-tile-sub' }, '命中 ' + fmtTokens(totals.cache_read) + ' · 新 ' + fmtTokens(fresh)),
          ),
        ]
