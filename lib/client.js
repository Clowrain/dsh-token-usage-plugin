...
.bmon-gh-week{display:flex;flex-direction:column;gap:2px;flex:1 1 0;min-width:0;}
.bmon-gh-cell{flex:1 1 0;aspect-ratio:1/1;min-width:6px;min-height:6px;border-radius:3px;background:var(--bmon-h0);}
