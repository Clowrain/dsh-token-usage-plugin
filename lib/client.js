...
.bmon-u-num{text-align:right;}`)
      ...
      function UsageTiles({ stats, range }) {
        ...
        // 单价悬浮层：悬停「查看单价」时拉取并展示缓存的单价表
        const pricePop = React.useState(null) // { x, y, prices }
        ...
        const tiles = [
          ...
          React.createElement('div', { key: 't4', className: 'bmon-u-tile' },
            ...
            React.createElement('div', { className: 'bmon-u-tile-sub' },
              ...
              React.createElement('div', null, '新 ' + fmtTokens(fresh)),
            ),
          ),
        ]
        ...
        return React.createElement('div', { className: 'bmon-u-tiles' },
