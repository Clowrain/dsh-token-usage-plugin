...
.bmon-u-record-scroll{max-width:100%;max-height:300px;overflow:auto;contain:layout paint style;overscroll-behavior:contain;}
...
.bmon-u-heat-scroll{max-width:100%;overflow-x:auto;overflow-y:visible;padding:2px 2px 4px;}
.bmon-u-heat-body{display:flex;gap:5px;width:max-content;min-width:100%;}
.bmon-u-heat-weekdays{display:flex;flex:none;flex-direction:column;gap:3px;font-size:9px;color:var(--dsw-alias-label-secondary);}
.bmon-u-heat-weekdays span{height:10px;line-height:10px;}
.bmon-u-heat-cols{display:flex;flex:none;gap:3px;min-width:max-content;}
.bmon-u-heat-col{display:flex;flex:none;flex-direction:column;gap:3px;width:10px;min-width:10px;}
